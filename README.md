...
```javascript
import { ccopy, cscal, csrot, cswap, dasum, daxpy, dcopy, ddot, dnrm2, drot, drotm, dscal, dswap, idamax, isamax, sasum, saxpy, scopy, sdot, snrm2, srot, srotm, sscal, zcopy, zdrot, zswap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm@esm/index.mjs';
```
